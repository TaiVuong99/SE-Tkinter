...
root.title("Tính tổng 2 số")
root.grid()

lbl1=Label(root, text="Nhập a", font=("TimeNewRoman",20))
lbl1.pack()
tx_1= Entry(root, width=30, font=("TimeNewRoman",20))
tx_1.pack()

lbl2=Label(root, text="Nhập b", font=("TimeNewRoman",20))
lbl2.pack()
...
lbl2=Label(root, text="a + b = ", font=("TimeNewRoman",20))
lbl2.pack()
